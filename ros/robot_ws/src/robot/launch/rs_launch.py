...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'color_width',                  'default': '320', 'description': "''"},                           
                           {'name': 'color_height',                 'default': '240', 'description': "''"},                           
                           {'name': 'depth_fps',                    'default': '6', 'description': "''"},                           
                           {'name': 'depth_width',                  'default': '320', 'description': "''"},                           
                           {'name': 'depth_height',                 'default': '240', 'description': "''"},                           
                           {'name': 'pointcloud.enable',            'default': 'true', 'description': ''}, 
                           {'name': 'pointcloud.stream_filter',     'default': '1', 'description': 'texture stream for pointcloud'},
                           {'name': 'pointcloud.stream_index_filter','default': '0', 'description': 'texture stream index for pointcloud'},
                           {'name': 'enable_sync',                  'default': 'false', 'description': "''"},                           
                           {'name': 'align_depth.enable',           'default': 'false', 'description': "''"},                           
                           {'name': 'colorizer.enable',             'default': 'true', 'description': "''"},
